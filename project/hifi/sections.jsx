...
function PlateMockHi({ lang }) {
  const isPT = lang === "pt";
  const meta = isPT ? "single · lança em 24.05" : "single · drops 05.24";
  const titleTxt = "Maré viva";
  const artistTxt = "Volmério Costa";
  const releaseTxt = isPT ?
  "Gravada em uma noite só, na varanda da minha avó em Olinda. Tem a voz dela no final, sem ela saber. É uma música sobre voltar pra casa." :
  "Recorded in a single night on my grandma's porch in Olinda. Her voice is in the ending — she didn't know. A song about coming home.";
        ...
        <div className="hf-phone-frame hf-phone-frame-lg">
          <div className="hf-phone-screen">
            <div className="hf-plate-mobile">
              ...
              <div className="hf-plate-mobile-cover hf-plate-cover-volmerio">
                <div className="hf-plate-cover-text">
                  <div className="hf-plate-cover-title">MARÉ&nbsp;VIVA</div>
                  <div className="hf-plate-cover-artist">VOLMÉRIO COSTA</div>
                </div>
